        ...
        <Col md={6}>
          ...
          <Row className="align-items-center social flex-column flex-md-row">
            <Col md={8} className="d-flex flex-column flex-md-row align-items-center">
              <a href="/TDat_CV.pdf" download="TDat_CV.pdf" className="text-decoration-none">
              ...
              <div className="d-flex justify-content-center">
                <a href="https://www.facebook.com/truong.thanhdat.759388" target="_blank" rel="noopener noreferrer" className="me-2"><FaFacebook size={30} /></a>
                <a href="https://github.com/Thanhdat3010" target="_blank" rel="noopener noreferrer" className="me-2"><FaGithub size={30} /></a>
              </div>
            </Col>
          </Row>
        </Col>
